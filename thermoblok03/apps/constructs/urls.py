...
from .views import IndexViews, catalog_view, product_detail_view, product_edit, toggle_active, set_main_image, delete_image, reorder_images, project_list
...
urlpatterns = [
    ...
    path('', pl, name='index'),
    path('<slug:product_slug>/', product_edit, name='project_detail'),
